...
int main() {
    ...
    // Create a cursor at the first peg's position
    // The cursor is a triangle shape with a yellow color
    ...
    while (window.isOpen()) {
        ...
        if (game.isGameWon(pegs, NUM_DISKS)) {
            std::cout << "You won the game!\n";
            window.close();  // Close the window if the game is won
        }
